          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-6 text-lg">
              ...
              <span className="font-bold text-[#053980]">
                Instituto Ação Saúde
              </span>{" "}
              é um órgão não governamental, com o propósito de levar acesso à
              saúde integralmente à quem precisa.
            </p>
            <div className="bg-[#ff7415] bg-opacity-10 border-l-4 border-[#ff7415] p-4 rounded mb-6">
              <p className="text-[#053980] font-medium italic">
                "Eu faço o bem" - Nosso lema que inspira cada ação e cada
                voluntário em nossa organização.
              </p>
            </div>
          </div>
        </div>
